...
<?php
  ...
  if ($nivel != 1) {
    if ($nivel1 != false) {
      ...
      $breadcrumbs .= "<li class='breadcrumb-item'><a href='verbete_testes.php?concurso=$concurso&tema=$id_nivel1'>$nivel1</a></li>";
    }
  }
  else {
  ...
  if ($nivel != 2) {
    if ($nivel2 != false) {
      ...
      $breadcrumbs .= "<li class='breadcrumb-item'><a href='verbete_testes.php?concurso=$concurso&tema=$id_nivel2'>$nivel2</a></li>";
    }
  }
  else {
  ...
  if ($nivel != 3) {
    if ($nivel3 != false) {
      ...
      $breadcrumbs .= "<li class='breadcrumb-item'><a href='verbete_testes.php?concurso=$concurso&tema=$id_nivel3'>$nivel3</a></li>";
    }
  }
  else {
  ...
  if ($nivel != 4) {
    if ($nivel4 != false) {
      ...
      $breadcrumbs .= "<li class='breadcrumb-item'><a href='verbete_testes.php?concurso=$concurso&tema=$id_nivel4'>$nivel4</a></li>";
    }
  }
  else {
