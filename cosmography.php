...
<div class="container-fluid">
    <div class="row sticky-top">
        <div id="cosmography_container" class="col-12">
            <h1>Cosmography</h1>
            <p>A personalized encyclopedia, a diary of impressions, a record of what you value and admire, an AI-powered memory palace, the future of learning.</p>
            <button class="btn btn-primary">Add topic of interest</button>
            <h2>Your topics of interest</h2>
        </div>
    </div>
</div>
<script>
