            ...
            <?php
                ...
                if ($result->num_rows > 0) {
                  ...
                  while($row = $result->fetch_assoc()) {
                    ...
                    $materia = $row["materia"];
                    echo "
                      <div href='materia.php?sigla=$sigla&concurso=$concurso' class='col-lg-2 col-sm-12 bg-lighter rounded bdark cardmateria text-break text-center align-middle my-2 mx-2'>
