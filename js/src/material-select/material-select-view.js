...
class MaterialSelectView {
  ...
  bindMaterialSelectKeydown() {
    ...
    this.$materialSelect.on('keydown', (e) => {
      ...
      switch (true) {
        case isEnterWithShift: return this._handleEnterWithShiftKey($this);
        case isEnter: return this._handleEnterKey($this);
        case isArrowDown || isArrowUp: return this._handleArrowUpDownKey(e.which);
        case isEsc: return this._handleEscKey($this);
        default: return this._handleLetterKey(e);
      }
      /* eslint-disable consistent-return */
    });
  }
