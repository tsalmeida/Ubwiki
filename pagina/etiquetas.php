<?php
	...
	if ($etiquetas->num_rows > 0) {
		while ($etiqueta = $etiquetas->fetch_assoc()) {
			...
			$etiqueta_pagina_estado_icone = return_estado_icone($etiqueta_pagina_estado);
			$template_modal_body_conteudo .= "<a href='pagina.php?etiqueta_id=$etiqueta_id'><li class='list-group-item border-top list-group-item-action d-flex justify-content-between mt-1'><span><span class='link-warning'><i class='fad fa-tag fa-fw'></i></span> $etiqueta_titulo</span><span><i class='fad $etiqueta_pagina_estado_icone fa-fw'></i></span></li></a>";*/
		}
	}
	$template_modal_body_conteudo .= "<span data-bs-toggle='modal' data-bs-target='#modal_secao_etiquetas'>";
