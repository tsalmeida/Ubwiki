          ...
          echo "
            <div class='col-lg-6 col-sm-6'>
              ...
              <h2 class='text-center'>Tópicos de $nome_materia</h2>
                ...
                $result = $conn->query("SELECT id, sigla_materia, nivel, nivel1, nivel2, nivel3, nivel4, nivel5 FROM Temas WHERE concurso = '$concurso' AND sigla_materia = '$sigla_materia' ORDER BY parent_id");
                if ($result->num_rows > 0) {
                  while($row = $result->fetch_assoc()) {
                    $active1 = false; $active2 = false; $active3 = false; $active4 = false; $active5 = false;
                    $id_lista = $row['id'];
