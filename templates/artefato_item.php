<?php
	...
	if (!isset($artefato_badge)) {
		...
		$artefato_badge = "<span class='badge badge-pill grey lighten-2 text-dark artefato-badge position-absolute z-depth-0'><i class='fad $artefato_badge fa-fw'></i></span>";
	}
