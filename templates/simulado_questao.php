		...
		<script type='text/javascript'>
			$(document).ready(function(){
				$('#enviar_respostas_{$questao_id}').click(function () {
					...
					$.post('engine.php', {'user_id': {$user_id}, 'questao_id': {$questao_id}, 'questao_tipo': {$questao_tipo}, 'simulado_id': {$simulado_id}, 'item1': item1_resposta, 'item2': item2_resposta, 'item3': item3_resposta, 'item4': item4_resposta, 'item5': item5_resposta}, function(data) {
					    if (data != 0) {
		...
		<script type='text/javascript'>
			$(document).ready(function(){
			    ...
			    var item5_resposta = $('input[id=item5_{$questao_id}]:checked').val();
					...
					$.post('engine.php', {'user_id': {$user_id}, 'questao_id': {$questao_id}, 'questao_tipo': {$questao_tipo}, 'simulado_id': {$simulado_id}, 'resposta': item_resposta}, function(data) {
					    if (data != 0) {
								$('#enviar_respostas_{$questao_id}').prop('disabled', true);
					    }
					})
