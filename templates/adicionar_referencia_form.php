<?php
	...
	$form_return .= "
		...
		<div class='row d-flex justify-content-start'>
			<div class='col'>
				<button type='button' class='btn btn-outline-primary mb-3' id='trigger_buscar_referencias'>{$pagina_translated['Buscar']}</button>
			</div>
		</div>
		<div class='row' id='referencias_disponiveis'></div>
		<div class='row' id='criar_referencia_form'>
			<div class='col-12'>
				...
				<button type='button' class='btn btn-outline-primary mb-2' id='trigger_buscar_autores'>{$pagina_translated['Buscar']}</button>
				<div class='row border p-1' id='autores_disponiveis'></div>
				<input type='hidden' id='criar_referencia_tipo' name='criar_referencia_tipo' value='referencia'>
				<input type='hidden' id='criar_referencia_subtipo' name='criar_referencia_subtipo' value='livro'>
				<div class='row justify-content-center mt-2'>
					<button type='button' class='btn btn-primary col-12 mb-2' id='trigger_adicionar_referencia'>$adicionar_referencia_form_botao</button>
				</div>
			</div>
		</div>
  ";
