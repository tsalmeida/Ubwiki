			...
			<?php
				...
				if ($anotacoes_publicadas->num_rows > 0) {
					while ($anotacao_publicada = $anotacoes_publicadas->fetch_assoc()) {
						...
						$template_botoes .= "<a class='$thumbs_color h3 upvote' id='upvote_$anotacao_publicada_id' value='$anotacao_publicada_id'><i class='fad fa-thumbs-up fa-fw'></i><span class='upvote_score' id='upvote_$anotacao_publicada_id'>$anotacao_score</span></a>";
