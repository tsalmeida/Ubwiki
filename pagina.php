    ...
    <div class="row justify-content-between">
        <div class='py-2 text-left col'>
					<?php
						...
						} elseif ((($pagina_tipo == 'sistema') && ($user_tipo == 'admin')) || (($pagina_tipo == 'pagina') && ($pagina_user_id == $user_id))) {
    ...
    <div class="row justify-content-around <?php echo $row_classes; ?>">
        <div id="coluna_unica" class="col-lg-10 col-md-12 pagina_coluna">
			...
			<?php
				...
				$audios = $conn->query("SELECT DISTINCT elemento_id FROM Paginas_elementos WHERE pagina_id = $pagina_id AND tipo = 'album_musica'");
...
";
	...
	if ((($pagina_tipo == 'sistema') && ($user_tipo == 'admin')) || (($pagina_tipo == 'pagina') && ($pagina_user_id == $user_id))) {
		$template_modal_div_id = 'modal_pagina_dados';
		$template_modal_titulo = 'Alterar dados da página';
		$template_modal_body_conteudo = false;
		$template_modal_body_conteudo .= "
            <div class='md-form mb-2'>
                ...
                <label data-error='inválido' data-success='válido'
                       for='nova_imagem_titulo'>Título da página</label>
            </div>
        ";
		include 'templates/modal.php';
	}
