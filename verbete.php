  ...
  <div class='container-fluid grey lighten-5' data-toggle='buttons'>
    <div class='row'>
      <div class='col-12 d-flex justify-content-center'>
        ...
        <button class='btn grey lighten-3 btn-rounded btn-sm collapse anotacoes_collapse collapse ml-1' data-toggle='collapse' data-target='.anotacoes_collapse' role='button'>Anotações</button>
      </div>
    </div>
  </div>
...
<?php
    load_footer();
    bottom_page("quill_v", 'carousel', 'lightbox-imagens', 'collapse_stuff', 'bookmark_stuff', 'testing');
    $conn->close();
?>
