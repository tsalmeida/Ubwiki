	...
	$template_modal_body_conteudo = "
        ...
        <div class='md-form mb-2'>
            ...
            <select class='mdb-select' name='novo_estado_pagina'>
                ...
                <option value='2' $active2>Rascunho</option>
                <option value='3' $active3>Razoável</option>
                <option value='4' $active4>Bom</option>
                <option value='5' $active5>Excepcional</option>
            </select>
        </div>
    ";
