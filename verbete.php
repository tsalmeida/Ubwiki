...
<?php
  ...
  if ($nivel == 1) {
    ...
    while ($row = $result->fetch_assoc()) {
      $count++;
      if ($count == 2) { $fawesome = false; $spacing = 'spacing2'; }
      $id_nivel1 = $row['id'];
  ...
  <div class='container-fluid grey lighten-3'>
    <div class='row'>
      ...
      <div class='col-lg-6 col-sm-12 d-flex justify-content-center'>
        <button class='btn transparent verbete_collapse collapse mostrar_coluna_esquerda px-2' data-toggle='collapse' data-target='.verbete_collapse' role='button'>Verbete</button>
        <button class='btn transparent imagens_collapse collapse mostrar_coluna_esquerda px-2' data-toggle='collapse' data-target='.imagens_collapse' role='button'>Imagens</button>
        <button class='btn transparent videos_collapse collapse mostrar_coluna_esquerda px-2' data-toggle='collapse' data-target='.videos_collapse' role='button'>Vídeos</button>
        <button class='btn transparent bibliografia_collapse collapse mostrar_coluna_esquerda px-2' data-toggle='collapse' data-target='.bibliografia_collapse' role='button'>Leia mais</button>
        <button id='mostrar_anotacoes' class='btn transparent collapse anotacoes_collapse collapse px-2' data-toggle='collapse' data-target='.anotacoes_collapse' role='button'>Anotações</button>
      </div>
      <div class='col-lg-3 col-sm-12'>
