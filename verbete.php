...
<div class='container-fluid'>
    ...
    ";
            ...
            ";
								...
								echo "
								    <span id='change_estado_pagina' class='ml-1' title='Estado da página' data-toggle='modal' data-target='#modal_estado'><a href='javascript:void(0);'><i class='$icone_estado fa-fw'></i></a></span>
								";
							?>
            </div>
        </div>
	...
	$template_modal_body_conteudo = "
        ...
        <div class='md-form mb-2'>
            ...
            <select class='mdb-select' name='novo_estado_pagina'>
                ...
                <option value='1' selected>Vazio</option>
