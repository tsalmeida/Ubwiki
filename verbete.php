  ...
  <div class='container-fluid text-center'>
    <div class='row'>
      <div class='col-lg-2 col-sm-12'>
        <div class='border p-3 mt-3 elegant-color text-white sticky'>
          <ul class='list-group text-center'>
            <a class='list-group-item list-group-item-action border-0 p-1 text-white elegant-color' href='#verbete' title='Verbete'><i class="fal fa-file-alt fa-2x fa-fw"></i> <span class='d-block'>Verbete</span></a>
            <a class='list-group-item list-group-item-action border-0 p-1 text-white elegant-color' href='#imagens' title='Imagens'><i class="fal fa-images fa-2x fa-fw"></i> <span class='d-block'>Imagens</span></a>
            <a class='list-group-item list-group-item-action border-0 p-1 text-white elegant-color' href='#verbetes' title='Relacionados'><i class="fal fa-copy fa-2x fa-fw"></i> <span class='d-block'>Relacionados</span></a>
            <a class='list-group-item list-group-item-action border-0 p-1 text-white elegant-color' href='#bibliografia' title='Bibliografia'><i class="fal fa-books fa-2x fa-fw"></i> <span class='d-block'>Bibliografia</span></a>
            <a class='list-group-item list-group-item-action border-0 p-1 text-white elegant-color' href='#videos' title='Vídeos e aulas'><i class="fal fa-chalkboard-teacher fa-2x fa-fw"></i> <span class='d-block'>Vídeos e aulas</span></a>
            <a class='list-group-item list-group-item-action border-0 p-1 text-white elegant-color' href='#links' title='Links'><i class="fal fa-link fa-2x fa-fw"></i> <span class='d-block'>Links</span></a>
            <a class='list-group-item list-group-item-action border-0 p-1 text-white elegant-color' href='#anotacao' title='Anotações'><i class="fal fa-user-edit fa-2x fa-fw"></i> <span class='d-block'>Anotações</span></a>
            <a class='list-group-item list-group-item-action border-0 p-1 text-white elegant-color' href='#questoes' title='Questões'><i class="fal fa-trophy fa-2x fa-fw"></i> <span class='d-block'>Questões</span></a>
            <a class='list-group-item list-group-item-action border-0 p-1 text-white elegant-color' href='#discussao' title='Fórum'><i class="fal fa-comments-alt fa-2x fa-fw"></i> <span class='d-block'>Fórum</span></a>
          </ul>
        </div>
      </div>
