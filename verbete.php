  ...
  <div class='container-fluid grey lighten-5' data-toggle='buttons'>
    <div class='row d-flex justify-content-between'>
      ...
      <div class='col-2 d-flex justify-content-right'>
        <button class='btn btn-primary-sm collapse anotacoes_collapsible inactive' data-toggle='collapse' data-target='.anotacoes_collapsible'><a href='#'><i class='fal fa-user-edit'></i></a></button>
      </div>
    </div>
  </div>
